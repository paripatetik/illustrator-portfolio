      ...
      >
        <div className="mx-auto flex min-h-full w-fit items-center">
          ...
          <div className="mb-2 flex items-center justify-between">
            <span className="lightbox-counter min-w-[5ch] rounded-full bg-[color:var(--surface-rose)] px-3 py-1.5 text-white border border-white/30 backdrop-blur-sm leading-none">
